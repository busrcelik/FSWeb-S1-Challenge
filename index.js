...
console.log(
  fenomenEkle(fenomenler, 6, "Workintech", 100000000, 2022, "Instagram")
);
...
function fenomenGonderimSayisi(dizi, profile) {
  for (let i = 0; i < dizi.length; i++) {
    if (dizi[i].profile.toLowerCase() == profile.toLowerCase()) {
      return dizi[i].posts;
    }
  }
}
